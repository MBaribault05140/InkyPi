...
class Weather(BasePlugin):
    ...
    def parse_weather_data(self, weather_data, aqi_data, visibility_miles, tz):
        ...
        if daily:
            ...
            high_temp = today.get("air_temp_high", 0)
            low_temp = today.get("air_temp_low", 0)
        else:
            high_temp = low_temp = 0  # Fallback if no data
        ...
        data = {
            ...
            "temperature_unit": "°F",
            "units": "imperial",
            "high_temp": high_temp,  # Add the high temp
            "low_temp": low_temp,    # Add the low temp
